...
| **Does re-weighting make past purchases retroactively illegal?** | **No. `D ≤ ρ·(C + P)` is evaluated at the moment of the transaction.** A revision changes future debit-room and never invalidates a completed act | §3.3 |
