...
> **Reads against:** `Aequitas_Foundations_v0.29.md` A1, A7, §3.2, §3.2b, §4.1, §4.4, §4.4, §4.4, §4.4, §4.8, §4.7, §4.5, §5.5 · `06-simulation/scenario-suite/q4_locked_ledgers.py` · `06-simulation/residual-unravelling/residual_unravelling.py`
