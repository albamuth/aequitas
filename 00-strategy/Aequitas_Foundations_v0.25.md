...
**What may not vary.** The axioms above, and the conformance requirements in [`Aequitas_Conformance_v0.2.md`](Aequitas_Conformance_v0.2.md).
...
> **The dial test is the standing screening question for anything proposed for these documents, and what it leaves behind is a set of conformance requirements, never an architecture** — [`Aequitas_Conformance_v0.2.md`](Aequitas_Conformance_v0.2.md). **What must be true, never how to build it.**
