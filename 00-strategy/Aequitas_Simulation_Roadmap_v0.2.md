...
> **Companions:** `Aequitas_Foundations_v0.26.md` §1.2/§9 (scope, conformance list), `Aequitas_Strategy_v0.6.md` §2, `06-simulation/scenario-suite/scenario_suite_METHOD.md`.
...
[`Aequitas_Conformance_v0.5.md`](../00-strategy/Aequitas_Conformance_v0.5.md) carries **16 requirements that must hold for an implementation to be Aequitas.** They were written for an implementer. **They are also exactly what the kernel should assert, every period, in every scenario.**
