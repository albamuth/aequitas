...
> **Companions:** `Aequitas_Foundations_v0.43.md` §2.6/§9 (scope, conformance list), `Aequitas_Strategy_v0.9.md` §2, `06-simulation/scenario-suite/scenario_suite_METHOD.md`.
