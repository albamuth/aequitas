...
> **Companions:** `Aequitas_Foundations_v0.20.md` §1.2/§9 (scope, conformance list), `Aequitas_Strategy_v0.5.md` §2, `06-simulation/scenario-suite/scenario_suite_METHOD.md`.
