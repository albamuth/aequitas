...
> **Companions:** `Aequitas_Foundations_v0.29.md` §1.2/§9 (scope, conformance list), `Aequitas_Strategy_v0.6.md` §2, `06-simulation/scenario-suite/scenario_suite_METHOD.md`.
