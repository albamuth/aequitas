...
> **Tracks:** `Aequitas_Foundations_v0.25.md` §5.0 · §5.1 · §5.3c · §6.4b · §7.5.5 · `Aequitas_Conformance_v0.4.md` · `Aequitas_Objections_v0.23.md` OA9
...
**This is now conformance requirement 4a** ([`Aequitas_Conformance_v0.4.md`](Aequitas_Conformance_v0.4.md)), added because the rule lived only in §6.4b's prose and a project paper walked straight past it.
...
| 3a | A conformance item for one-human-one-account | [`Aequitas_Conformance_v0.4.md`](Aequitas_Conformance_v0.4.md) | ❌ **Not added, deliberately.** The ruling makes it a within-network rule, so Foundations §5.1 carries it. |
