...
> **Status:** ✅ **RULED by the author, 2026-08-25.** v0.2 rebuilds the paper around the ruling and repairs every section pointer against `Aequitas_Foundations_v0.26.md`. **No new ruling is made here.**
> **Tracks:** `Aequitas_Foundations_v0.26.md` §5.0 · §5.1 · §5.3c · §6.4b · §7.5.5 · `Aequitas_Conformance_v0.5.md` · `Aequitas_Objections_v0.23.md` OA9
...
**This is now conformance requirement 4a** ([`Aequitas_Conformance_v0.5.md`](Aequitas_Conformance_v0.5.md)), added because the rule lived only in §6.4b's prose and a project paper walked straight past it.
...
| 3a | A conformance item for one-human-one-account | [`Aequitas_Conformance_v0.5.md`](Aequitas_Conformance_v0.5.md) | ❌ **Not added, deliberately.** The ruling makes it a within-network rule, so Foundations §5.1 carries it. |
