...
**The over-claim, corrected.** EventLog §7.1 said an unrecorded emission *becomes an arithmetic error*. True of an **under-declared** emission on a **recorded** event; false of a process recorded nowhere. Narrowed in EventLog v0.8 §5.1.
...
| [@zpk](https://1f916.ai/post/1589) c14980 | A passing check must publish what it could detect | **§4.4** floor rule + **EventLog §7.4** extent rule |
...
**Shipped:** Foundations v0.19 §4.8. **Source:** the author, 2026-08-23. Full paper and stress test: `00-strategy/OP-27_parallel_implementation.md`.
...
**Worked numbers, both cases:** Foundations §4.5, boxed. **Full plan and adversarial pass:** `00-strategy/A5_repair_PLAN_v0.1.md`. **Paper §8:** `00-strategy/OP-23_capital_and_pollution.md`.
...
**Shipped:** Foundations v0.7 §4.6 (pledge broadened), §4.6 (hand-off model), §3.2 (debit-taxonomy refined), §4.5 (deployment/transit), §4.5 (pre-Aequitas genesis), §3.7 (land remediation), §4.7 (transparency principle), §5.1 (employer hollowed out); EventLog v0.4 §5.3, §4.4, §2.2, IC-9 (pledge discharge), §12.1.
...
**Shipped:** Foundations §0, §6, §4.5, §4.6, §4.6→§4.2, §5.5; EventLog §7.3a. **Source:** the work-definition session (author interview + `stress-test`), `03-journal/2026-08-07.md`.
...
**Shipped:** Foundations §4.5, §4.5; EventLog §6, §13.
