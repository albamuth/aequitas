...
> **Tested against:** `Aequitas_Foundations_v0.25.md` §5.1b, §5.1c, §5.1d, §3.3a, §5.3a, A8.
...
`06-simulation/residual-unravelling/residual_unravelling.py` measures that price: **once verification costs more than about 40% of a median unit's debit, the dark pool stops shrinking and stabilises at 96.4% dark.** That is Foundations §5.3a, item (b), and it was written before this comment.
