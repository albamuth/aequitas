...
> **Companion docs:** `Aequitas_Foundations_v0.33.md` (axioms), `Aequitas_Objections_v0.24.md` (register), `Aequitas_Conformance_v0.10.md` (what an implementation must satisfy), `../NEXT.md` (task queue)
