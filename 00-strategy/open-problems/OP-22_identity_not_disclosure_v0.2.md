...
> **Tracks:** `Aequitas_Foundations_v0.33.md` §4.0 · §4.1 · §4.8 · §4.2 · §5.5.5 · `Aequitas_Conformance_v0.9.md` · `Aequitas_Objections_v0.24.md` OA9
...
**This is now conformance requirement 4a** ([`Aequitas_Conformance_v0.9.md`](../Aequitas_Conformance_v0.9.md)), added because the rule lived only in §4.2's prose and a project paper walked straight past it.
...
| 3a | A conformance item for one-human-one-account | [`Aequitas_Conformance_v0.9.md`](../Aequitas_Conformance_v0.9.md) | ❌ **Not added, deliberately.** The ruling makes it a within-network rule, so Foundations §4.1 carries it. |
