...
> **Reads against:** `Aequitas_Foundations_v0.20.md` A1, A7, §3.2, §3.2b, §5.1, §5.1a, §5.1b, §5.1c, §5.1d, §5.2, §5.3a, §6.2a, §7.5 · `06-simulation/scenario-suite/q4_locked_ledgers.py` · `06-simulation/residual-unravelling/residual_unravelling.py`
