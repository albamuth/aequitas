...
**Compiled:** 2026-08-23
**Bears on:** the simulator's consumer cohorts ([`06-simulation/STATERA_PLAN_v0.2.md`](../sims/STATERA_PLAN_v0.2.md) §4), the culture and locale dials, and any scenario that asks *"which mix of people makes Aequitas stable?"*
...
> **All of these report money.** Turning money into hours, kilograms, and megajoules is a separate step with its own note: [Labour and pollution intensity](../docs/GLOSSARY.md#src-labour-and-pollution-intensity).
...
- [Labour and pollution intensity](../docs/GLOSSARY.md#src-labour-and-pollution-intensity) — the money-to-hours conversion these surveys need
- [Estimation-engine data sources](../docs/GLOSSARY.md#src-estimation-engine-data-sources) — the supply-chain tracing machinery
- [Cross-country labour efficiency](../docs/GLOSSARY.md#src-cross-country-labour-efficiency) — the Q6 result the locale dial must reproduce
- [Veblen — conspicuous consumption](../docs/GLOSSARY.md#src-veblen-conspicuous-consumption) — the one classical treatment of *why* consumption differs by group
