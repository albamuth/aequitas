...
Bears on: pricing scarcity as a cost, not a profit (the "scarcity-as-debit" idea — see [Kantorovich](../docs/GLOSSARY.md#src-kantorovich-shadow-prices)); the demand-side reply to the calculation critique ([`00-strategy/OP-9_calculation_reply.md`](../docs/OP-9_calculation_reply.md)); and [Foundations §6.4 (pledges and signals)](../docs/Aequitas_Foundations_v0.16.md#64-pledges-and-signals).
