...
Bears on: pricing scarcity as a cost, not a profit (the "scarcity-as-debit" idea — see [Kantorovich](../docs/GLOSSARY.md#src-kantorovich-shadow-prices)); the demand-side reply to the calculation critique ([`00-strategy/OP-9_calculation_reply.md`](../docs/OP-9_calculation_reply.md)); and [Foundations §6.4 (pledges and signals)](../docs/Aequitas_Foundations_v0.17.md#64-pledges-and-signals).
...
- **Live prior art for Aequitas's two hardest open edges.** Dapprich is working the same two problems Aequitas flags — pricing scarcity honestly, and surfacing demand without a market — and has a *running* model. His scarcity-values are the strongest external template for Aequitas's "scarcity is a real cost, recorded as debit" idea. See [Kantorovich](../docs/GLOSSARY.md#src-kantorovich-shadow-prices).
- **His consumer-feedback loop is a check on Aequitas's pledges.** Where Dapprich feeds back consumer *uptake* into the plan, Aequitas surfaces demand as *pledges* — people putting earned credit behind what they want made. Comparing the two is a way to stress-test whether pledges really do the job a feedback loop does. See [Foundations §6.4](../docs/Aequitas_Foundations_v0.17.md#64-pledges-and-signals).
...
- [Kantorovich: shadow prices](../docs/GLOSSARY.md#src-kantorovich-shadow-prices) · [Cockshott & Cottrell: labour-time](../docs/GLOSSARY.md#src-cockshott-cottrell-labour-time) · [Neurath: calculation in kind](../docs/GLOSSARY.md#src-neurath-calculation-in-kind)
