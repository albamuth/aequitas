...
- **A pollutant costs more the more of it is already out there** — because the more there is, the more work it takes to deal with. See [Foundations §3.5](../docs/Aequitas_Foundations_v0.16.md#35-the-books-never-balance--and-must-not).
- **Recycled material is cheaper because it never carried the original mining/drilling pollution** — that stayed with whoever first extracted it. See [Foundations §3.6](../docs/Aequitas_Foundations_v0.16.md#36-end-of-life-recycling-and-product-as-pollution).
...
- [Estimation-engine data sources](../docs/GLOSSARY.md#src-estimation-engine-data-sources) · [[retroactive-reweighting]] · [[material-flow-value]]
