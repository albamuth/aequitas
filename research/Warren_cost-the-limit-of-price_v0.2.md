# "Cost the Limit of Price" and the Cincinnati Time Store

**Version:** 0.2
**Type:** historical experiment / doctrine
**Author(s):** Josiah Warren (1798–1874)
**Published:** the store operated 1827–1830; the doctrine was written up in *Equitable Commerce* (1846) and *True Civilization* (1863)
**Retrieved:** 2026-07-31
**URL:** [Cost the limit of price](https://en.wikipedia.org/wiki/Cost_the_limit_of_price) · [Cincinnati Time Store](https://en.wikipedia.org/wiki/Cincinnati_Time_Store) · [libcom: Josiah Warren](https://libcom.org/library/16-josiah-warren)
...
That central idea is measuring everything in **time** — the hours a thing took — as the one yardstick that means the same thing everywhere. See [Foundations §A2 (time as measure)](../docs/Aequitas_Foundations_v0.16.md#a2-time-as-measure). And the "price is just cost, no profit" rule is [Foundations §A5 (price ≡ cost)](../docs/Aequitas_Foundations_v0.16.md#a5-price--cost). Warren tested both, a century and a half early, and hit the wall that Aequitas claims to get past.
...
**The doctrine**
- "Cost" to Warren meant the **effort a person put in** — their toil and discomfort — not the money that changed hands. He was following Adam Smith's "toil and trouble" idea of what a thing really costs.
- If the fair payment for labour is an equal amount of labour, then profit, rent, and interest are all unjust — they are payment for no work.
- The French thinker Pierre-Joseph Proudhon arrived at the same doctrine independently, some years later. Two people reaching the same rule separately is a mild sign the rule isn't arbitrary (see [Proudhon: mutualism](../docs/GLOSSARY.md#src-proudhon-mutualism)).
- Benjamin Tucker later popularised the idea through his journal *Liberty*.

**Why it ultimately failed**
- Warren could never settle how to handle differences in **skill** and in how **unpleasant** a job was. An hour of delicate expert work and an hour of drudgery both counted as one hour — and that felt wrong to everyone, including him.
- He patched it case by case, adjusting pay for difficulty, but could never state a *principle* for doing so. In the end he **"settled to simply credit it with being a matter of individual judgment"** — i.e. he gave up and let a person decide.
...
- [ ] Source *Equitable Commerce* (1846) — it is public domain and should be on archive.org.
- [ ] Research the Utopia, OH and Modern Times, NY communities specifically.
- [ ] Find a first-hand account from 1827–30 rather than relying on later summaries.
