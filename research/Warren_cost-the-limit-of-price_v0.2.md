...
That central idea is measuring everything in **time** — the hours a thing took — as the one yardstick that means the same thing everywhere. See [Foundations §A2 (time as measure)](../docs/Aequitas_Foundations_v0.19.md#a2-time-as-measure). And the "price is just cost, no profit" rule is [Foundations §A5 (price ≡ cost)](../docs/Aequitas_Foundations_v0.19.md#a5-price--cost). Warren tested both, a century and a half early, and hit the wall that Aequitas claims to get past.
