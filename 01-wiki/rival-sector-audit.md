...
>
> **What is true now.** Rival-sector audit is **one pressure among several, not a mechanism.** How a trust network audits its cost constants is a network-design problem held to five published requirements — [Foundations §3.3a](../00-strategy/Aequitas_Foundations_v0.40.md), open problem **OP-24 (understatement drift)**.
>
