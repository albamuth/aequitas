...
|---|---|---|
| **Embodied material** | The atoms you hold | **Dischargeable** — rides the object to the new holder; you are clear of it. |
| **Creation-cost / labour** | The hours that *made* the thing | **Permanent per holder** — holding-time split (your share = your holding-duration ÷ the asset's whole life). Dilutes as later holders accrue time, never zeroes; freezes at disposal. (§4.5) |
...
This one distinction does an enormous amount of the theory's work. It makes **property a burden rather than an engine**.
...
**Debit dumping.** The exploit would be to offload high-debit property onto someone with debit-room to spare. Two things now blunt it: the *material* transfers but the **creation-cost does not** (your holding-time share stays with you), and **custody is accepted, not imposed** (§3.2b) — you cannot be forced to *receive* an object, though if you accept one you cannot disclaim the debit that rides with it. The residue is *illicit* dumping — abandoning a thing in the environment to escape its end-of-life debit — parked as **OP-25**.
...
- C5 — debit transfer rules
- Consent and refusal on acquisition


## Why the barn is not in the beef
...
## The capital-debit waterfall, in full
