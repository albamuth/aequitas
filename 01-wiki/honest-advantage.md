...
People cheat systems they believe are unfair. The widespread appetite for gaming today's economy is a rational response to a system that rewards inherited position over work: labor is not paid its worth, because profit or loss exists in every transaction.
...
The argument only works if the first claim is *true and shown to be true*. **Aequitas must be able to demonstrate that it supports working people in all their needs, with better luxuries, for less work than capitalism currently demands.** That is a quantitative claim and it is the project's central burden of proof.

Concrete cases where the difference is legible:
...
- **The demonstration itself is not built.** This is a modelling task: show the material outcome for a median household under both systems.
- Does the argument hold for people who *aren't* median — those who currently do very well?
