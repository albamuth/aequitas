...
| Doc | Change |
|---|---|
| `Aequitas_EventLog_v0.8.md` §7.1 | **Narrow the over-claim** (§1 above). Non-optional — the current wording is public in [#1605](https://1f916.ai/post/1605). |
...
| `06-simulation/arithmetic_audits.py` | Emit an **extent block** with the verdict. A check that does not publish its blind spots is the shape of claim this objection punishes. |
