...
**Each claim ships with a Python simulation that demonstrates it.** The sims are figures and appendices in the whitepaper, not a separate deliverable. This is what separates Aequitas from every other utopian economic proposal — *ours has results.*
