...
> **⚠️ There is no right to be forgotten, and that is a real adoption obstacle rather than a detail.** Several jurisdictions grant a legal right to erasure of personal data. **Aequitas cannot honour it without breaking recomputation**, so this is a genuine collision between the design and existing law, and it should be met by argument rather than by hoping nobody notices. **Registered; unresolved.**
>
