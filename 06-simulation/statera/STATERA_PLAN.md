...
> **Parent:** [`../../00-strategy/Aequitas_Simulation_Roadmap.md`](../../00-strategy/Aequitas_Simulation_Roadmap.md) — this is **step 2**, and **Phase 1** of [`LAB_DESIGN.md`](LAB_DESIGN.md).
...
3. **Timescales get long.** Adoption is generational — see [`../../00-strategy/papers/Onboarding_the_wealthy.md`](../../00-strategy/papers/Onboarding_the_wealthy.md), where the arithmetic runs to 70–170 years. **The period length must be a dial.**
...
**Two corrections applied first, both settled by the author on 2026-08-23** — see [`SUBSECTOR_CANDIDATES.md`](SUBSECTOR_CANDIDATES.md) §0.
...
>
> **Check it against our intensity figure.** At $56.00 of spend per embodied hour (§1 of [Labour and pollution intensity](../../02-research/Data_labour-and-pollution-intensity.md)):
>
...
**Full list and reasoning: [`SUBSECTOR_CANDIDATES.md`](SUBSECTOR_CANDIDATES.md) §0.**
...
`Aequitas_Conformance.md` lists **17 conformance requirements**. v0.1 could express 10 of them. v0.2 adds three.
