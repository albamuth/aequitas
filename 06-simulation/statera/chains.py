...
class Chain:
    ...
    def handoff(self, frm: int, to: int, labour_h: float = 0.0, note: str = "",
        ...
        WHY A HARD REFUSAL AND NOT A PRICED PATH. "Price it, don't forbid it" is
        not a universal rule of this system; it fits only where the costly path has
        a legitimate use. Here there is none, for three reasons (the ruling and how
        it was reached are in CHANGELOG.md, v0.2, section 3):
