...
- **This is the academic paper's Sraffa/ISO reply in concrete form** (`Aequitas_Conformance_v0.2.md`): process-physics allocation gives a different, universality-satisfying answer where price allocation is arbitrary — now on real DOE energy data.
