...
> **Supersedes:** `99-archive/Aequitas_Overview_v0.4.md`. v0.5 folds in the work-definition work: **credit is time *spent*, not effort — so caring for yourself (sleep, food, rest) is work, exactly as caring for someone else is; that is what puts a floor under everyone; and because time is handed out perfectly equally — 24 hours a day, and you cannot buy anyone else's — the gap between the most and least is capped by arithmetic, not by any rule.** The problem/solution structure is unchanged.
> **Rigorous version:** `00-strategy/Aequitas_Foundations_v0.8.md`. This document is the plain-language companion; where they differ, the Foundations govern.
...
**And here is why the gap between most and least is *capped* — by arithmetic, not by any rule.** Money can be piled up without limit; time cannot. Everyone gets the same 24 hours a day, you cannot buy anyone else's, and credit — a record of *your* time — never moves. So the most anyone can out-earn anyone else is the ratio between a full day's work and the baseline everyone already gets for living. If a community counts, say, 10 hours a day as the cost of simply keeping yourself going, the busiest possible contributor tops out around 24 ÷ 10 — under three times the person who only lives. Set against today, where the top of the scale runs into the *millions* of times the bottom, that is a different universe. **The ceiling on inequality isn't policed into place; it falls out of measuring in time.** (How generous that baseline is remains a choice each community makes — see §10.)
...
**Training is work, and it is paid at the time.** A medical student is credited for their hours studying, exactly as a bricklayer is credited for hours laying bricks. The cost of that training — the teachers, the buildings, the equipment — is settled *during the training years*, by the people who wanted doctors to exist.

Which means: **the doctor's education never appears on any patient's bill.** Your visit costs their time, the clinic's materials, and the medicines you were given. Nothing else. It was already paid for.
...
> **A large up-front cost with a spread-out benefit is paid when it happens, by the people who wanted it. It is never charged downstream to whoever happens to use the result.**
...
**And this is the only thing that lets the books ever close.** Picture charging a hospital's construction to its patients. To do it honestly you would have to fold in the builder's costs, and the cement plant's, and the steel mill's, and the schooling of the engineers who designed the place — back and back, with no end, to the first human who ever built anything. The sum never finishes. Front-loading is what stops the regress: a building's cost is settled once, by the people who wanted it there, and a patient's bill never reaches back past the front door.

**So who carries a building year to year?** The community pledges most of the cost up front. Whatever is left rides the **building itself**, shared among the people who run it — and shared *by how long each has worked there*. A nurse hired on Monday inherits almost none of it; a thirty-year veteran a little more. Nobody takes on a whole hospital by walking in the door — which is exactly what would otherwise scare people away from staffing the places that need it most.
...
**And the barn is nobody's share of the hide.** The buildings, the tools, the machinery — the *capital* a business runs on — never get sliced up and dribbled into each product either. They are paid for the same way a hospital is (§2): pledged up front, then carried by the people who run the place. A wafer is not charged a fraction of the factory that made it. This closes a question that quietly defeats ordinary cost accounting — *how much of the fab belongs in one chip?* — by answering: none of it. The fab belongs to the people who run the fab.
...
**The answer is that people spend their credit on wanting things.** Two instruments, separated by one test: *does it commit you to absorbing the debit?*

| | **Pledge** | **Signal** |
|---|---|---|
| Means | "I'll spend an hour of my credit to make this work happen" | "I want this to exist" |
| Backed by | your earned credit, one-for-one | nothing |
| How much | exactly one hour pledged per hour worked | plenty — signal freely |
| Familiar as | a pre-order; choosing your GP; crowdfunding; commissioning a job | likes, reviews, applause |

**A pledge summons work — it doesn't have to be about a *thing*.** Say you've earned four hours and you pledge two toward mowing the scrappy public verge on your street. Someone with a mower sees it, spends an hour, shows proof, and earns an hour of credit. That's the whole transaction — no object changed hands, nobody's credit was cancelled, and one pledged hour is still waiting for next month. A pledge is simply you spending some of your earned credit to **call real, credited work into being.** It's deliberately messy — people will pledge for silly things, pledges will go unfilled, groups will form to coordinate them — and that's fine. Messy or not, it's the thing that creates jobs.
...
They must be strictly one-to-one. If you could pledge more than you have worked, more cost gets committed than can be absorbed, the goods arrive and nobody can take them, and the maker is left holding it. That's not a preference, it's arithmetic.
...
*(If you make things nobody has pledged for, you're taking a real gamble — you hold the goods and their debt until someone wants them, exactly as an entrepreneur does today. Make things people **have** pledged for, and a buyer is already lined up.)*
...
**On the "you can't calculate an economy" objection**, which is the standard academic reply: the in-principle version has an answer, and the practical version has been tested. [Cockshott and Cottrell](https://en.wikipedia.org/wiki/Towards_a_New_Socialism) showed that calculation in physical units at national scale is computationally tractable with sparse-matrix methods. People ran the arithmetic; it runs.
...
*For the rigorous statement of everything above, with the arguments and the open problems in full: `00-strategy/Aequitas_Foundations_v0.8.md`.*
