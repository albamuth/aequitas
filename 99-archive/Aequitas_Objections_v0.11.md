...
> **Version:** 0.11 · **Date:** 2026-08-10
> **Supersedes:** `99-archive/Aequitas_Objections_v0.10.md` — **the electricity-attribution fold.** New stress-test verdict **B12 — the §3.2b real-time-dispatch principle (electricity generation → consumer), PASSES WITH CHANGES.** The raw "all generation pollution to the consumer" was caught weakening the decarbonisation incentive on a pooled grid; the adopted fix attributes by the consumer's **contracted supply mix** (provenance, §5.1b), preserving both conservation and decarbonisation incentives. Grid emission factor registered under **OP-24 (understatement drift)** / §3.3a rival-audit; a universality edge (real-time-vs-batch spectrum) flagged open. Prior fold (v0.10) below.
...
> **Tracks:** `Aequitas_Foundations_v0.10.md` · `Aequitas_EventLog_v0.5.md` · `OP-18_labour_and_team_credit.md` · `OP-23_capital_and_pollution.md` · `OP-17_coproduct_allocation.md` · `06-simulation/RESULTS.md`
