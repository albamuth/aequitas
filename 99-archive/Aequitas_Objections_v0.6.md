...
> **Version:** 0.6 · **Date:** 2026-08-04
> **Supersedes:** `99-archive/Aequitas_Objections_v0.5.md` — **OP-23 closed and moved to Part B (B8); OP-25 added; OP-24's lever enlarged by the new stock/baseline constants.**
> **Tracks:** `Aequitas_Foundations_v0.5.md` · `Aequitas_EventLog_v0.3.md` · `OP-23_capital_and_pollution.md` · `OP-17_coproduct_allocation.md` · `OP-16_authorization_stress_test.md`
...
**Twelve items closed; seven live.** The pattern in what closes has held for a fourth session: **every closure came from removing a division or from finding that the division was a measurement all along — never from picking a split.** OP-23 closed by removing the allocation entirely — capital accrues to the asset, not to the co-products.
...
**What remains genuinely indivisible is small and sharply defined.** After v0.6 it is **one** item at two scales: **labour across co-products, and responsibility across a team — both OP-18.** Every case is one where no instrument will ever help, because there is nothing to instrument.
