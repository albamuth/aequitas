...
> **Version:** 0.7 · **Date:** 2026-08-05
> **Supersedes:** `99-archive/Aequitas_Objections_v0.6.md` — **OP-18 closed as the C3 blocker and moved to Part B (B9): team-credit dissolves under A2; labour-across-co-products rides the material split by declared convention; co-product cost is embodied input, not scarcity. §C Test 1 (recursion convergence) resolved by the sim.**
> **Tracks:** `Aequitas_Foundations_v0.6.md` · `Aequitas_EventLog_v0.3.md` · `OP-18_labour_and_team_credit.md` · `OP-23_capital_and_pollution.md` · `OP-17_coproduct_allocation.md` · `06-simulation/RESULTS.md`
...
**Thirteen items closed; six live.** The pattern held for a fourth session and then broke on the fifth in an instructive way: OP-17, OP-11, OP-21, OP-23 all closed by *removing* a division. **OP-18 is the first to close by *declaring* a convention** — because labour genuinely leaves no trace, the physical-trace test *mandates* a convention here. The discipline was in choosing the least-arbitrary one (labour rides the already-audited material split, adding no new lever) rather than pretending a measurement exists. **Its team-credit half still dissolved** — under A2, so even here half the problem evaporated against an axiom.
