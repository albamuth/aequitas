...
> **Supersedes:** `99-archive/Aequitas_Overview_v0.9.md`. **Pledge-mechanics correction + presentation cleanup**, conforming this document to Foundations v0.13. A pledge no longer "spends" or "absorbs" anything: it is a **revocable grant of backing** — you put an hour of your earned credit behind making something happen, your credit stays yours, and you can withdraw it. It is not a promise to buy; taking the finished good is a separate step you pay for with your own room. Fixed everywhere pledges appear (§2, §4, §6). Also: inline version-notes stripped, a table of contents added, and the change history moved to `Aequitas_Overview_CHANGELOG.md`.
> **Rigorous version:** `00-strategy/Aequitas_Foundations_v0.13.md`. This document is the plain-language companion; where they differ, the Foundations govern.
...
**A pledge doesn't spend your credit, and it isn't a promise to buy.** Your credit stays yours — a pledge just puts it *behind* something, the way naming a beneficiary doesn't hand over your bank balance. It gives whoever you're backing more room to carry the cost of the work, and **you can take it back at any time** if they lose your confidence. The only thing it costs you is that credit you've pledged can't also be pledged elsewhere.
...
They must be strictly one-to-one: the credit you put behind things can never exceed the credit you've actually earned. Let it, and people would be backing work with room that isn't really there — so when demand or a wave of withdrawals arrived, the makers leaning on it would be stranded. That's not a preference, it's arithmetic.
...
*(If you make things nobody has pledged for, you're taking a real gamble — you hold the goods and their debt until someone wants them, exactly as an entrepreneur does today. Make things people **have** pledged for and the gamble is much smaller — there's committed interest behind the run — though a pledge can be withdrawn, so it softens the risk rather than erasing it.)*
...
*For the rigorous statement of everything above, with the arguments and the open problems in full: `00-strategy/Aequitas_Foundations_v0.13.md`.*
