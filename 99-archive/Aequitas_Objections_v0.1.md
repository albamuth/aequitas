...
> **v0.2 adds:** §4 (field record), OP-19, one defensive win (A3 vs. the sink problem), and empirical confirmation that OP-16 is fatal untreated.
...
| Item | Action | Where |
|---|---|---|
| P7 wording | **Amend §0 and A1 — theory of cost, not value.** Cheap, high value. | Foundations v0.3 |
