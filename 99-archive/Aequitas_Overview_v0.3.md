...
> **Supersedes:** `99-archive/Aequitas_Overview_v0.2.md`. v0.3 folds in the capital-and-pollution work: **historical costs don't cascade downstream, pollution stays with whoever caused it, and you own the end of a thing's life.** The problem/solution structure is unchanged.
> **Rigorous version:** `00-strategy/Aequitas_Foundations_v0.5.md`. This document is the plain-language companion; where they differ, the Foundations govern.
...
**So who carries a building year to year?** The community pledges most of the cost up front. Whatever is left rides the **building itself**, shared among the people who run it — and shared *by how long each has worked there*. A nurse hired on Monday inherits almost none of it; a thirty-year veteran a little more; and when you leave, your share fades behind you. Nobody takes on a whole hospital by walking in the door — which is exactly what would otherwise scare people away from staffing the places that need it most.
...
| | **Pledge** | **Signal** |
|---|---|---|
| Means | "I will take on this cost" | "I want this to exist" |
| Backed by | your earned credit | nothing |
| How much | exactly one hour pledged per hour worked | plenty — signal freely |
| Familiar as | a pre-order; choosing your GP; crowdfunding | likes, reviews, applause |
...
- **Splitting credit within a team.** Responsibility for joint work is genuinely joint — there is no physical measurement that says which share of a bridge each builder is responsible for. The current rule is hours-worked, which is defensible and simple, but it is **a convention we chose, not a fact we found**, and it is labelled as such.
...
*For the rigorous statement of everything above, with the arguments and the open problems in full: `00-strategy/Aequitas_Foundations_v0.5.md`.*
