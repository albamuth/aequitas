...
> **Supersedes:** `99-archive/Aequitas_Overview_v0.10.md`. **Pledges are now permanent, and over-pledging funds an insurance pool for dangerous work**, conforming this document to Foundations v0.14. A pledge is a *permanent* backing you cannot take back — you spend it once from a lifetime allowance equal to what you've earned, and your credit itself stays yours. When more people pledge to a job than it costs (say a toxic-cleanup nobody wants), the extra doesn't become a bonus — it becomes an earmarked fund that only pays out if the work later harms whoever did it. That is how Aequitas rewards nasty-but-needed work without a danger-bonus. Fixed everywhere pledges appear (§2, §4, §6). Also: change history in `Aequitas_Overview_CHANGELOG.md`.
> **Rigorous version:** `00-strategy/Aequitas_Foundations_v0.15.md`. This document is the plain-language companion; where they differ, the Foundations govern.
...
*For the rigorous statement of everything above, with the arguments and the open problems in full: `00-strategy/Aequitas_Foundations_v0.15.md`.*
