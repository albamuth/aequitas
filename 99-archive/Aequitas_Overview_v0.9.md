...
> **Supersedes:** `99-archive/Aequitas_Overview_v0.8.md`. **Scenario-suite fold (§1).** Two reader-facing additions from the societal-scale simulations: **(1) money wealth isn't material wealth** — Aequitas never counts stocks, bonds, or crypto (they aren't matter or energy), and once you look only at what people physically hold and consume, the gap between richest and poorest is already ~1,000× smaller than the money picture (a billionaire's *stuff* is a few hundred times the average, not a million times); **(2) there's no shortage of hands** — because looking after yourself counts as work, there is far more human labour available than any economy needs, so what actually limits a society is materials and energy, never a lack of hours. *(Prior: v0.8 put the pollution from your electricity on you, the person who draws it. v0.7 embedded the debit-taxonomy schematic and made the inequality-cap claim conditional.)*
> **Rigorous version:** `00-strategy/Aequitas_Foundations_v0.12.md`. This document is the plain-language companion; where they differ, the Foundations govern.
...
*For the rigorous statement of everything above, with the arguments and the open problems in full: `00-strategy/Aequitas_Foundations_v0.12.md`.*
