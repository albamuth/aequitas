...
> **Supersedes:** `99-archive/Aequitas_Overview_v0.3.md`. v0.4 folds in the credit-realization work: **you're credited when your work is verified — for a thing you made, that's when it changes hands; a "pledge" is how people summon work they want; you keep a share of what you made even after passing it on; land can't be owned; and the market is public while people stay private.** The problem/solution structure is unchanged. *(Also catches up the OP-18 labour work from Foundations v0.6.)*
> **Rigorous version:** `00-strategy/Aequitas_Foundations_v0.7.md`. This document is the plain-language companion; where they differ, the Foundations govern.
...
**And nobody starves for having a low score.** Every account carries a **debit tolerance** — an amount you may hold with no work behind it, scaled by age and circumstance. Exceeding it restricts *luxuries*, never necessities. A nurse is credited for nursing you whatever your books look like. This is not charity bolted onto the system; it is a structural requirement, because a system where being mis-measured can starve you is a system nobody should adopt.
...
- **Turning contribution into influence.** How much say people get, and how it accrues, is unsettled. The leading candidate is that everyone accrues the same influence per hour worked — which is not a voting scheme and is deliberately not one.
...
*For the rigorous statement of everything above, with the arguments and the open problems in full: `00-strategy/Aequitas_Foundations_v0.7.md`.*
