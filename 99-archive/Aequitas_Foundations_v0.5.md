...
> **Supersedes:** `99-archive/Aequitas_Foundations_v0.4.md`. **OP-23 resolved (capital front-loading + holding-time-split); §3.2 rewritten — pollution/transport never transfer; §3.3 gains stock-dependence; new §3.6 recycling & end-of-life; §6.2a/§6.2b capital; §7.2 rewritten to producer-side incentive.** See §12. Resolution note: `00-strategy/OP-23_capital_and_pollution.md`.
...
**What this does not cover, and does not pretend to:** **labour** (no trace from the farmer's hours to the hide — that is **OP-18**, still a declared §1.1 convention). *Shared overhead was OP-23; v0.5 closed it — capital and overhead accrue to the asset and never allocate to co-products (§6.2b).*
