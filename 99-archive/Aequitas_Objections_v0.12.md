...
> **Version:** 0.12 · **Date:** 2026-08-10
> **Supersedes:** `99-archive/Aequitas_Objections_v0.11.md` — **the disparity-ceiling simulation fold.** §C **test 8 (the disparity-ceiling proof) moves from "owed" to "simulated"**: `06-simulation/disparity_ceiling_sim.py` shows the `24/F` ceiling exact and **ρ-independent** (and weighting-independent — not dependent on OP-10), a **ρ that clears the market and tightens under shocks**, and **fraud-invariance** (IC-7 caps every account at 24 h/day). Still **conditional on OP-22**; the like-for-like vs real wealth micro-data is the one remaining piece. Prior fold (v0.11) below.
...
> **Tracks:** `Aequitas_Foundations_v0.11.md` · `Aequitas_EventLog_v0.5.md` · `OP-18_labour_and_team_credit.md` · `OP-23_capital_and_pollution.md` · `OP-17_coproduct_allocation.md` · `06-simulation/RESULTS.md` · `06-simulation/DISPARITY_CEILING.md`
