...
**Art 89 attaches safeguards**, chiefly data minimisation and **pseudonymisation where the purpose can still be achieved**. Aequitas is unusually well placed here: the **uniqueness ≠ identification** ruling (`00-strategy/papers/C2_information_capture.md` §3, §8) means a network must establish that an account is *one human*, never *which* human. **A pseudonymised ledger is the design, not a concession made to satisfy Art 89.**
