...
> **✅ STATUS — 2026-08-01. This problem is solved for the material/energy side.** See [`00-strategy/open-problems/OP-17_coproduct_allocation.md`](../00-strategy/open-problems/OP-17_coproduct_allocation.md) and [Foundations §3.4a](../00-strategy/Aequitas_Foundations_v0.39.md). The solution did *not* come from this literature — it came from noticing what this literature was fruitlessly searching for, and why Aequitas doesn't have to. This note is kept in full because it records exactly the objections a hostile economist will raise.
