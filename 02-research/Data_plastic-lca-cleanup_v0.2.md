...
- **A pollutant costs more the more of it is already out there** — because the more there is, the more work it takes to deal with. See [Foundations §3.5](../00-strategy/Aequitas_Foundations_v0.29.md).
- **Recycled material is cheaper because it never carried the original mining/drilling pollution** — that stayed with whoever first extracted it. See [Foundations §3.6](../00-strategy/Aequitas_Foundations_v0.29.md#36-end-of-life-recycling-and-product-as-pollution).
