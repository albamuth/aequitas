...
> **This closes the open task in [Joint-production problem](../00-strategy/GLOSSARY.md#src-joint-production-allocation-problem)** ("source refinery per-fuel process energy — none found yet").
...
- [[co-product-allocation]] · [[physical-trace-test]] · [[price-equals-cost]] · [Joint-production problem](../00-strategy/GLOSSARY.md#src-joint-production-allocation-problem)
