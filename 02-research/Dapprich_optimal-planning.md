...
Bears on: pricing scarcity as a cost, not a profit (the "scarcity-as-debit" idea — see [Kantorovich](../00-strategy/GLOSSARY.md#src-kantorovich-shadow-prices)); the demand-side reply to the calculation critique ([`00-strategy/open-problems/OP-9_calculation_reply.md`](../00-strategy/open-problems/OP-9_calculation_reply.md)); and [Foundations §6.4 (pledges and signals)](../00-strategy/Aequitas_Foundations.md).
