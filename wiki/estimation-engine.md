...
Full source map with links: `../docs/GLOSSARY.md#src-estimation-engine-data-sources`.
...
*Source: `../docs/GLOSSARY.md#src-estimation-engine-data-sources`; `00-strategy/OP-17_coproduct_allocation.md` §10*
