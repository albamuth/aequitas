...
> **Status:** ✅ **BUILT & RUN 2026-08-05 — PASS.** Written 2026-08-04. Implementation: [`recursion_convergence.py`](recursion_convergence.py); results: [`RESULTS.md`](RESULTS.md).
...
*When done: results → a new `02-research`-style note or a `06-simulation/RESULTS.md`; update Objections `§C` Test 1 and NEXT.md; if it passes, it becomes the first piece of C11.*
