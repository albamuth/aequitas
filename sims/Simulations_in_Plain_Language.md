...
**File:** [`refinery_slice.py`](refinery_slice.py), write-up [`REFINERY.md`](REFINERY.md), table [`refinery_allocation.csv`](refinery_allocation.csv), data sources [`../00-strategy/GLOSSARY.md#src-refinery-process-energy`](../00-strategy/GLOSSARY.md#src-refinery-process-energy).
