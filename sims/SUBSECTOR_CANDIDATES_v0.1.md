...
> **⚠️ But the existing median-lifestyle work may already be right.** [`MEDIAN_LIFESTYLE_RESULT.md`](MEDIAN_LIFESTYLE_RESULT.md) was built on **PCE**, not CE — and PCE *does* include employer-paid health insurance and government benefits in kind. **So the 1,380 h/yr anchor probably covers this, and only the new cohort work has the gap.**
>
