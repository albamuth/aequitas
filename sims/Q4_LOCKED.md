...
- Median US adult footprint ~1,600 h/yr — [`median_lifestyle_RESULTS.md`](median_lifestyle_RESULTS.md) (this project).
...
- Wealth tail — SCF 2022 / Forbes, via [`disparity_ceiling_sim.py`](disparity_ceiling_sim.py).
